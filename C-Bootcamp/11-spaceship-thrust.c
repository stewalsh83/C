 ...
 * We now want to log (print) the thrust level in some critical points:
...
// 1. build a new enum with the levels defined in the specification
// 2. define the constants
// 3. declare the trust variable
// 4. set trust values for each critical point